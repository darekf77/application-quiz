 ...
 */
export const CURRENT_PACKAGE_VERSION = '0.0.20';

export namespace TAON_CLOUDFLARE_WORKERS_URLS {
	export const KvWorkerApplicationQuizCustom08263 = 'https://kv-worker-application-quiz-custom-08263.undefined.workers.dev';
}
